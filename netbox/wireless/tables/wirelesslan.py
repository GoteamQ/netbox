...
class WirelessLANGroupTable(NestedGroupModelTable):
    wirelesslan_count = columns.LinkedCountColumn(
        viewname='wireless:wirelesslan_list', url_params={'group_id': 'pk'}, verbose_name=_('Wireless LANs')
    )
    tags = columns.TagColumn(url_name='wireless:wirelesslangroup_list')
...
class WirelessLANTable(TenancyColumnsMixin, PrimaryModelTable):
    ssid = tables.Column(verbose_name=_('SSID'), linkify=True)
    ...
    tags = columns.TagColumn(url_name='wireless:wirelesslan_list')
