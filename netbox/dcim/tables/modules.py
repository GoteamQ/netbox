...
class ModuleTypeProfileTable(PrimaryModelTable):
    ...
    tags = columns.TagColumn(url_name='dcim:moduletypeprofile_list')
...
class ModuleTypeTable(PrimaryModelTable):
    profile = tables.Column(verbose_name=_('Profile'), linkify=True)
    manufacturer = tables.Column(verbose_name=_('Manufacturer'), linkify=True)
    model = tables.Column(linkify=True, verbose_name=_('Module Type'))
    ...
    tags = columns.TagColumn(url_name='dcim:moduletype_list')
...
class ModuleTable(PrimaryModelTable):
    ...
    module_bay = tables.Column(verbose_name=_('Module Bay'), linkify=True)
    manufacturer = tables.Column(
        verbose_name=_('Manufacturer'), accessor=tables.A('module_type__manufacturer'), linkify=True
    )
    module_type = tables.Column(verbose_name=_('Module Type'), linkify=True)
    status = columns.ChoiceFieldColumn(
        verbose_name=_('Status'),
    )
    tags = columns.TagColumn(url_name='dcim:module_list')
