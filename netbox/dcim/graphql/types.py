...
@strawberry_django.type(models.Cable, fields='__all__', filters=CableFilter, pagination=True)
...
@strawberry_django.type(models.ConsolePort, exclude=['_path'], filters=ConsolePortFilter, pagination=True)
class ConsolePortType(ModularComponentType, CabledObjectMixin, PathEndpointMixin):
    pass


@strawberry_django.type(
    models.ConsolePortTemplate, fields='__all__', filters=ConsolePortTemplateFilter, pagination=True
)
class ConsolePortTemplateType(ModularComponentTemplateType):
    pass


@strawberry_django.type(models.ConsoleServerPort, exclude=['_path'], filters=ConsoleServerPortFilter, pagination=True)
class ConsoleServerPortType(ModularComponentType, CabledObjectMixin, PathEndpointMixin):
    pass


@strawberry_django.type(
    models.ConsoleServerPortTemplate, fields='__all__', filters=ConsoleServerPortTemplateFilter, pagination=True
)
class ConsoleServerPortTemplateType(ModularComponentTemplateType):
    pass


@strawberry_django.type(models.Device, fields='__all__', filters=DeviceFilter, pagination=True)
...
@strawberry_django.type(models.DeviceBay, fields='__all__', filters=DeviceBayFilter, pagination=True)
class DeviceBayType(ComponentType):
    installed_device: Annotated['DeviceType', strawberry.lazy('dcim.graphql.types')] | None


@strawberry_django.type(models.DeviceBayTemplate, fields='__all__', filters=DeviceBayTemplateFilter, pagination=True)
...
@strawberry_django.type(models.DeviceRole, fields='__all__', filters=DeviceRoleFilter, pagination=True)
...
@strawberry_django.type(models.DeviceType, fields='__all__', filters=DeviceTypeFilter, pagination=True)
...
@strawberry_django.type(models.FrontPort, fields='__all__', filters=FrontPortFilter, pagination=True)
...
@strawberry_django.type(models.FrontPortTemplate, fields='__all__', filters=FrontPortTemplateFilter, pagination=True)
...
@strawberry_django.type(
    models.MACAddress, exclude=['assigned_object_type', 'assigned_object_id'], filters=MACAddressFilter, pagination=True
)
...
@strawberry_django.type(models.Interface, exclude=['_path'], filters=InterfaceFilter, pagination=True)
...
@strawberry_django.type(models.InterfaceTemplate, fields='__all__', filters=InterfaceTemplateFilter, pagination=True)
...
@strawberry_django.type(models.InventoryItemRole, fields='__all__', filters=InventoryItemRoleFilter, pagination=True)
...
class LocationType(VLANGroupsMixin, ImageAttachmentsMixin, ContactsMixin, NestedGroupObjectType):
    ...
    def circuit_terminations(
        self,
    ) -> List[Annotated['CircuitTerminationType', strawberry.lazy('circuits.graphql.types')]]:
        return self.circuit_terminations.all()


@strawberry_django.type(models.Manufacturer, fields='__all__', filters=ManufacturerFilter, pagination=True)
...
@strawberry_django.type(models.Module, fields='__all__', filters=ModuleFilter, pagination=True)
...
@strawberry_django.type(models.ModuleBayTemplate, fields='__all__', filters=ModuleBayTemplateFilter, pagination=True)
class ModuleBayTemplateType(ModularComponentTemplateType):
    pass


@strawberry_django.type(models.ModuleTypeProfile, fields='__all__', filters=ModuleTypeProfileFilter, pagination=True)
class ModuleTypeProfileType(PrimaryObjectType):
    module_types: List[Annotated['ModuleType', strawberry.lazy('dcim.graphql.types')]]


@strawberry_django.type(models.ModuleType, fields='__all__', filters=ModuleTypeFilter, pagination=True)
...
@strawberry_django.type(models.Platform, fields='__all__', filters=PlatformFilter, pagination=True)
...
@strawberry_django.type(models.PortMapping, fields='__all__', filters=PortMappingFilter, pagination=True)
...
@strawberry_django.type(
    models.PortTemplateMapping, fields='__all__', filters=PortTemplateMappingFilter, pagination=True
)
...
@strawberry_django.type(models.PowerFeed, exclude=['_path'], filters=PowerFeedFilter, pagination=True)
...
@strawberry_django.type(models.PowerOutlet, exclude=['_path'], filters=PowerOutletFilter, pagination=True)
...
@strawberry_django.type(
    models.PowerOutletTemplate, fields='__all__', filters=PowerOutletTemplateFilter, pagination=True
)
...
@strawberry_django.type(models.PowerPanel, fields='__all__', filters=PowerPanelFilter, pagination=True)
...
@strawberry_django.type(models.PowerPort, exclude=['_path'], filters=PowerPortFilter, pagination=True)
class PowerPortType(ModularComponentType, CabledObjectMixin, PathEndpointMixin):
    poweroutlets: List[Annotated['PowerOutletType', strawberry.lazy('dcim.graphql.types')]]


@strawberry_django.type(models.PowerPortTemplate, fields='__all__', filters=PowerPortTemplateFilter, pagination=True)
...
@strawberry_django.type(models.RackType, fields='__all__', filters=RackTypeFilter, pagination=True)
class RackTypeType(ImageAttachmentsMixin, PrimaryObjectType):
    rack_count: BigInt
    manufacturer: Annotated['ManufacturerType', strawberry.lazy('dcim.graphql.types')]


@strawberry_django.type(models.Rack, fields='__all__', filters=RackFilter, pagination=True)
...
@strawberry_django.type(models.RackReservation, fields='__all__', filters=RackReservationFilter, pagination=True)
...
@strawberry_django.type(models.RackRole, fields='__all__', filters=RackRoleFilter, pagination=True)
...
@strawberry_django.type(models.RearPort, fields='__all__', filters=RearPortFilter, pagination=True)
...
@strawberry_django.type(models.RearPortTemplate, fields='__all__', filters=RearPortTemplateFilter, pagination=True)
...
@strawberry_django.type(models.Region, exclude=['parent'], filters=RegionFilter, pagination=True)
...
@strawberry_django.type(models.Site, fields='__all__', filters=SiteFilter, pagination=True)
...
@strawberry_django.type(models.VirtualChassis, fields='__all__', filters=VirtualChassisFilter, pagination=True)
...
@strawberry_django.type(
    models.VirtualDeviceContext, fields='__all__', filters=VirtualDeviceContextFilter, pagination=True
)
