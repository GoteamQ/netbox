...
@strawberry_django.type(
    models.ConfigContextProfile, fields='__all__', filters=ConfigContextProfileFilter, pagination=True
)
class ConfigContextProfileType(SyncedDataMixin, PrimaryObjectType):
    pass


@strawberry_django.type(models.ConfigContext, fields='__all__', filters=ConfigContextFilter, pagination=True)
...
@strawberry_django.type(models.ConfigTemplate, fields='__all__', filters=ConfigTemplateFilter, pagination=True)
...
@strawberry_django.type(models.CustomField, fields='__all__', filters=CustomFieldFilter, pagination=True)
...
@strawberry_django.type(
    models.CustomFieldChoiceSet, exclude=['extra_choices'], filters=CustomFieldChoiceSetFilter, pagination=True
)
...
@strawberry_django.type(models.CustomLink, fields='__all__', filters=CustomLinkFilter, pagination=True)
class CustomLinkType(OwnerMixin, ObjectType):
    pass


@strawberry_django.type(models.ExportTemplate, fields='__all__', filters=ExportTemplateFilter, pagination=True)
class ExportTemplateType(SyncedDataMixin, OwnerMixin, ObjectType):
    pass


@strawberry_django.type(models.ImageAttachment, fields='__all__', filters=ImageAttachmentFilter, pagination=True)
class ImageAttachmentType(BaseObjectType):
    object_type: Annotated['ContentTypeType', strawberry.lazy('netbox.graphql.types')] | None


@strawberry_django.type(models.JournalEntry, fields='__all__', filters=JournalEntryFilter, pagination=True)
...
@strawberry_django.type(models.NotificationGroup, filters=NotificationGroupFilter, pagination=True)
...
@strawberry_django.type(models.TableConfig, fields='__all__', filters=TableConfigFilter, pagination=True)
