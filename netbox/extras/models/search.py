...
class CachedValue(models.Model):
    ...
    timestamp = models.DateTimeField(verbose_name=_('timestamp'), auto_now_add=True, editable=False)
    ...
    class Meta:
        ...
        indexes = (models.Index(fields=('object_type', 'object_id'), name='extras_cachedvalue_object'),)
