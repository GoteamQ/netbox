...
@strawberry_django.type(models.ASN, fields='__all__', filters=ASNFilter, pagination=True)
...
@strawberry_django.type(models.ASNRange, fields='__all__', filters=ASNRangeFilter, pagination=True)
...
@strawberry_django.type(models.Aggregate, fields='__all__', filters=AggregateFilter, pagination=True)
...
@strawberry_django.type(models.FHRPGroup, fields='__all__', filters=FHRPGroupFilter, pagination=True)
...
@strawberry_django.type(models.IPRange, fields='__all__', filters=IPRangeFilter, pagination=True)
...
@strawberry_django.type(models.RIR, fields='__all__', filters=RIRFilter, pagination=True)
...
@strawberry_django.type(models.Role, fields='__all__', filters=RoleFilter, pagination=True)
...
@strawberry_django.type(models.RouteTarget, fields='__all__', filters=RouteTargetFilter, pagination=True)
...
@strawberry_django.type(
    models.Service, exclude=('parent_object_type', 'parent_object_id'), filters=ServiceFilter, pagination=True
)
...
@strawberry_django.type(models.ServiceTemplate, fields='__all__', filters=ServiceTemplateFilter, pagination=True)
class ServiceTemplateType(PrimaryObjectType):
    ports: List[int]


@strawberry_django.type(models.VLAN, exclude=['qinq_svlan'], filters=VLANFilter, pagination=True)
...
@strawberry_django.type(models.VLANGroup, exclude=['scope_type', 'scope_id'], filters=VLANGroupFilter, pagination=True)
...
@strawberry_django.type(
    models.VLANTranslationPolicy, fields='__all__', filters=VLANTranslationPolicyFilter, pagination=True
)
...
@strawberry_django.type(
    models.VLANTranslationRule, fields='__all__', filters=VLANTranslationRuleFilter, pagination=True
)
class VLANTranslationRuleType(NetBoxObjectType):
    policy: Annotated['VLANTranslationPolicyType', strawberry.lazy('ipam.graphql.types')] = strawberry_django.field(
        select_related=['policy']
    )


@strawberry_django.type(models.VRF, fields='__all__', filters=VRFFilter, pagination=True)
