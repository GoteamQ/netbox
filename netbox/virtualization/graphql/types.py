...
@strawberry_django.type(models.ClusterGroup, fields='__all__', filters=ClusterGroupFilter, pagination=True)
class ClusterGroupType(ContactsMixin, VLANGroupsMixin, OrganizationalObjectType):
    clusters: List[Annotated['ClusterType', strawberry.lazy('virtualization.graphql.types')]]


@strawberry_django.type(models.ClusterType, fields='__all__', filters=ClusterTypeFilter, pagination=True)
class ClusterTypeType(OrganizationalObjectType):
    clusters: List[ClusterType]


@strawberry_django.type(models.VirtualMachine, fields='__all__', filters=VirtualMachineFilter, pagination=True)
...
@strawberry_django.type(models.VMInterface, fields='__all__', filters=VMInterfaceFilter, pagination=True)
...
@strawberry_django.type(models.VirtualDisk, fields='__all__', filters=VirtualDiskFilter, pagination=True)
