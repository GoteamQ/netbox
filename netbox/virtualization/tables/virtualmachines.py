...
class VirtualMachineTable(TenancyColumnsMixin, ContactsColumnMixin, PrimaryModelTable):
    ...
    virtual_disk_count = tables.Column(verbose_name=_('Virtual Disks'))
...
class VMInterfaceTable(BaseInterfaceTable):
    ...
    tags = columns.TagColumn(url_name='virtualization:vminterface_list')
...
class VirtualMachineVMInterfaceTable(VMInterfaceTable):
    ...
    actions = columns.ActionsColumn(actions=('edit', 'delete'), extra_buttons=VMINTERFACE_BUTTONS)
...
class VirtualDiskTable(NetBoxTable):
    ...
    tags = columns.TagColumn(url_name='virtualization:virtualdisk_list')
