    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_node_count', models.IntegerField(blank=True, null=True)),
                ('max_node_count', models.IntegerField(blank=True, null=True)),
                ('autoscaling_enabled', models.BooleanField(default=False)),
