...
class PrivateServiceConnectTestCase(TestCase):
    ...
    def test_instance_group_creation(self):
        ig = InstanceGroup.objects.create(
            name='test-ig', project=self.project, zone='us-central1-a', target_size=3, is_managed=True
        )
    ...
    def test_unmanaged_instance_group_creation(self):
        ig = InstanceGroup.objects.create(
            name='test-unmanaged-ig', project=self.project, zone='us-central1-b', target_size=5, is_managed=False
        )
