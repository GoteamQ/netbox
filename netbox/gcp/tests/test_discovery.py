...
class GCPDiscoveryTestCase(TestCase):
    ...
    def test_discover_psc_resources(self, mock_build):
                    ...
                    'forwardingRules': [
                        {
                            ...
                            'region': 'https://www.googleapis.com/compute/v1/projects/xx/regions/us-central1',
                            'IPAddress': '10.0.0.5',
                            'target': 'https://www.googleapis.com/compute/v1/projects/xx/regions/us-central1/serviceAttachments/target-sa', # This field varies for PSC
        ...
        # I'll try to call `discover_service_attachments` and `discover_psc_endpoints` assuming they exist or will exist.
    ...
    def test_discovery_error_handling(self, mock_build):
        ...
        content = b'{"error": {"errors": [{"reason": "forbidden", "message": "Access Denied"}], "code": 403, "message": "Access Denied"}}'
