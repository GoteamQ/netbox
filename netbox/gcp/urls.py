...
urlpatterns = [
    ...
    path(
        'organizations/<int:pk>/discover/', views.GCPOrganizationDiscoverView.as_view(), name='gcporganization_discover'
    ),
    ...
    path(
        'compute-instances/import/', views.ComputeInstanceBulkImportView.as_view(), name='computeinstance_bulk_import'
    ),
    path(
        'compute-instances/delete/', views.ComputeInstanceBulkDeleteView.as_view(), name='computeinstance_bulk_delete'
    ),
    ...
    path(
        'instance-templates/import/',
        views.InstanceTemplateBulkImportView.as_view(),
        name='instancetemplate_bulk_import',
    ),
    path(
        'instance-templates/delete/',
        views.InstanceTemplateBulkDeleteView.as_view(),
        name='instancetemplate_bulk_delete',
    ),
    ...
    path(
        'cloud-spanner/import/',
        views.CloudSpannerInstanceBulkImportView.as_view(),
        name='cloudspannerinstance_bulk_import',
    ),
    path(
        'cloud-spanner/delete/',
        views.CloudSpannerInstanceBulkDeleteView.as_view(),
        name='cloudspannerinstance_bulk_delete',
    ),
    ...
    path(
        'storage-buckets/import/',
        views.CloudStorageBucketBulkImportView.as_view(),
        name='cloudstoragebucket_bulk_import',
    ),
    path(
        'storage-buckets/delete/',
        views.CloudStorageBucketBulkDeleteView.as_view(),
        name='cloudstoragebucket_bulk_delete',
    ),
    ...
    path(
        'pubsub-subscriptions/import/',
        views.PubSubSubscriptionBulkImportView.as_view(),
        name='pubsubsubscription_bulk_import',
    ),
    path(
        'pubsub-subscriptions/delete/',
        views.PubSubSubscriptionBulkDeleteView.as_view(),
        name='pubsubsubscription_bulk_delete',
    ),
    ...
    path(
        'memorystore/import/', views.MemorystoreInstanceBulkImportView.as_view(), name='memorystoreinstance_bulk_import'
    ),
    path(
        'memorystore/delete/', views.MemorystoreInstanceBulkDeleteView.as_view(), name='memorystoreinstance_bulk_delete'
    ),
    ...
    path(
        'external-vpn-gateways/import/',
        views.ExternalVPNGatewayBulkImportView.as_view(),
        name='externalvpngateway_bulk_import',
    ),
    path(
        'external-vpn-gateways/delete/',
        views.ExternalVPNGatewayBulkDeleteView.as_view(),
        name='externalvpngateway_bulk_delete',
    ),
    ...
    path(
        'interconnect-attachments/', views.InterconnectAttachmentListView.as_view(), name='interconnectattachment_list'
    ),
    path(
        'interconnect-attachments/add/',
        views.InterconnectAttachmentEditView.as_view(),
        name='interconnectattachment_add',
    ),
    path(
        'interconnect-attachments/import/',
        views.InterconnectAttachmentBulkImportView.as_view(),
        name='interconnectattachment_bulk_import',
    ),
    path(
        'interconnect-attachments/delete/',
        views.InterconnectAttachmentBulkDeleteView.as_view(),
        name='interconnectattachment_bulk_delete',
    ),
    ...
    path(
        'service-attachments/import/',
        views.ServiceAttachmentBulkImportView.as_view(),
        name='serviceattachment_bulk_import',
    ),
    path(
        'service-attachments/delete/',
        views.ServiceAttachmentBulkDeleteView.as_view(),
        name='serviceattachment_bulk_delete',
    ),
    path('service-attachments/<int:pk>/', include(get_model_urls('gcp', 'serviceattachment'))),
    path(
        'service-connect-endpoints/', views.ServiceConnectEndpointListView.as_view(), name='serviceconnectendpoint_list'
    ),
    path(
        'service-connect-endpoints/add/',
        views.ServiceConnectEndpointEditView.as_view(),
        name='serviceconnectendpoint_add',
    ),
    path(
        'service-connect-endpoints/import/',
        views.ServiceConnectEndpointBulkImportView.as_view(),
        name='serviceconnectendpoint_bulk_import',
    ),
    path(
        'service-connect-endpoints/delete/',
        views.ServiceConnectEndpointBulkDeleteView.as_view(),
        name='serviceconnectendpoint_bulk_delete',
    ),
