...
class ProviderTable(ContactsColumnMixin, PrimaryModelTable):
    ...
    accounts = columns.ManyToManyColumn(linkify_item=True, verbose_name=_('Accounts'))
    account_count = columns.LinkedCountColumn(
        viewname='circuits:provideraccount_list', url_params={'provider_id': 'pk'}, verbose_name=_('Account Count')
    )
    asns = columns.ManyToManyColumn(linkify_item=True, verbose_name=_('ASNs'))
    asn_count = columns.LinkedCountColumn(
        viewname='ipam:asn_list', url_params={'provider_id': 'pk'}, verbose_name=_('ASN Count')
    )
    ...
    tags = columns.TagColumn(url_name='circuits:provider_list')
...
class ProviderAccountTable(ContactsColumnMixin, PrimaryModelTable):
    ...
    tags = columns.TagColumn(url_name='circuits:provideraccount_list')
...
class ProviderNetworkTable(PrimaryModelTable):
    name = tables.Column(verbose_name=_('Name'), linkify=True)
    provider = tables.Column(verbose_name=_('Provider'), linkify=True)
    tags = columns.TagColumn(url_name='circuits:providernetwork_list')
