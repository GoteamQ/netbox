...
@strawberry_django.type(models.Provider, fields='__all__', filters=ProviderFilter, pagination=True)
...
@strawberry_django.type(models.ProviderAccount, fields='__all__', filters=ProviderAccountFilter, pagination=True)
class ProviderAccountType(ContactsMixin, PrimaryObjectType):
    provider: Annotated['ProviderType', strawberry.lazy('circuits.graphql.types')]
    circuits: List[Annotated['CircuitType', strawberry.lazy('circuits.graphql.types')]]


@strawberry_django.type(models.ProviderNetwork, fields='__all__', filters=ProviderNetworkFilter, pagination=True)
...
@strawberry_django.type(models.CircuitType, fields='__all__', filters=CircuitTypeFilter, pagination=True)
...
@strawberry_django.type(models.Circuit, fields='__all__', filters=CircuitFilter, pagination=True)
...
@strawberry_django.type(models.CircuitGroup, fields='__all__', filters=CircuitGroupFilter, pagination=True)
...
@strawberry_django.type(models.VirtualCircuitType, fields='__all__', filters=VirtualCircuitTypeFilter, pagination=True)
...
@strawberry_django.type(
    models.VirtualCircuitTermination, fields='__all__', filters=VirtualCircuitTerminationFilter, pagination=True
)
class VirtualCircuitTerminationType(CustomFieldsMixin, TagsMixin, ObjectType):
    ...
    interface: Annotated['InterfaceType', strawberry.lazy('dcim.graphql.types')] = strawberry_django.field(
        select_related=['interface']
    )


@strawberry_django.type(models.VirtualCircuit, fields='__all__', filters=VirtualCircuitFilter, pagination=True)
