...
PARAMS = (
    ...
    # Pagination
    ConfigParam(name='PAGINATE_COUNT', label=_('Default page size'), default=50, field=forms.IntegerField),
    ConfigParam(name='MAX_PAGE_SIZE', label=_('Maximum page size'), default=1000, field=forms.IntegerField),
    # Validation
    ConfigParam(
