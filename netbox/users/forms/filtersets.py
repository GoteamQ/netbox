...
class TokenFilterForm(SavedFiltersMixin, FilterForm):
    ...
    expires = forms.DateTimeField(required=False, label=_('Expires'), widget=DateTimePicker())
    last_used = forms.DateTimeField(required=False, label=_('Last Used'), widget=DateTimePicker())
...
class OwnerFilterForm(NetBoxModelFilterSetForm):
    ...
    group_id = DynamicModelMultipleChoiceField(queryset=OwnerGroup.objects.all(), required=False, label=_('Group'))
    user_group_id = DynamicModelMultipleChoiceField(queryset=Group.objects.all(), required=False, label=_('Groups'))
    user_id = DynamicModelMultipleChoiceField(queryset=User.objects.all(), required=False, label=_('Users'))
